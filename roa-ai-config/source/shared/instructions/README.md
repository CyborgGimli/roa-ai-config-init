...
Framework documentation references for ROA plugin development.

**IMPORTANT:** Do NOT read instructions here. Instead, read the actual ROA framework documentation in your target project:

- `.codex/instructions/core-framework-instructions.md` — Quest, rings, lifecycle patterns
